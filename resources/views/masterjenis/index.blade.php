...
<div class="page-titles">
  <h2> {{ $pageTitle }} <small> {{ $pageNote }} </small></h2>
	...
	<div id="masterjenisView"></div>	
	<div id="masterjenisGrid">
		<div class="card">
			<div class="card-body">
			...
			<div class="table-responsive">			
				<table id="masterjenisTable" class="display table  table-striped table-hover" cellspacing="0" width="100%">
			        <thead>
			            <tr>
			            	<th>ID</th>	
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$('#masterjenisTable tbody').on('click', 'td.details-control', function () {
	        ...
	        if ( row.child.isShown() ) {
	            ...
	            tr.addClass('shown');
	            $.get('{{ url("masterjenis/")}}/'+id , function(callback){
	            	$('#'+id).html(callback);
	            	$('#'+id).addClass('data');
	            })
	    ...
	    $('#masterjenisTable').Sdtable({
	    	tableId : '#masterjenis',
	    	table   : table,
	    	action  : '{{ url("masterjenis")}}' 
	    });
