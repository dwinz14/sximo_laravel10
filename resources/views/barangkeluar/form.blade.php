...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            ...
            {!! Form::open([
                'url' => 'barangkeluar?return=' . $return,
            ...
            <div class="">
                <div class="col-md-12">
                    <fieldset>
                        ...
                        <div class="form-group row  ">
                            <label for="Qty Keluar" class=" control-label col-md-4 "> Qty Keluar </label>
                            <div class="col-md-8">
                                <input type='text' name='qty_keluar' id='qty_keluar' value='{{ $row['qty_keluar'] }}'
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $("#nama_barang").jCombo("{!! url('barangkeluar/comboselect?filter=tb_barang:id:nama_barang') !!}", {
                selected_value: '{{ $row['nama_barang'] }}'
            });

            $("#jenis_barang").jCombo("{!! url('barangkeluar/comboselect?filter=tb_jenis:id:jenis_barang') !!}", {
            ...
            $('.removeMultiFiles').on('click', function() {
                var removeUrl = '{{ url('barangkeluar/removefiles?file=') }}' + $(this).attr('url');
                $(this).parent().remove();
