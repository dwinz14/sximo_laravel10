...
<html lang="en">
                      ...
                      <div class="card-body">
                        <div class="row">
                            <div class="col text-center">
                                <canvas id="GUNUNGPASANG" width="50" height="50" style="position: relative; height:70vh; width:70vw"></canvas>
                            </div>
                            <div class="col p-3">
                                <h6>Area</h6>
                                <p>Afd : 4</p>
  ...
  <script>
    ...
    GUNUNGPASANG.canvas.parentNode.style.height = '70px';
    GUNUNGPASANG.canvas.parentNode.style.width = '70px';
