...
class BarangmasukController extends Controller {
	...
	public static function display(  )
	{
		...
		$info = $model::makeInfo('barangmasuk');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('barangmasuk.public.view',$data);			
			}			
		} 
		else {
			...
			return view('barangmasuk.public.index',$data);	
		}
