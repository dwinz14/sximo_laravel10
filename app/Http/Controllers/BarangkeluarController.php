...
class BarangkeluarController extends Controller {
	...
	public static function display(  )
	{
		...
		$info = $model::makeInfo('barangkeluar');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('barangkeluar.public.view',$data);			
			}			
		} 
		else {
			...
			return view('barangkeluar.public.index',$data);	
		}
